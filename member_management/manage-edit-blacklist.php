  ...
  <div class="row justify-content-center align-items-center">
    <div class="card-body p-4 p-md-5">
      <form name="form1" method="post" onsubmit="sendData(event)">
        <h2 class="mb-2 pb-1 pb-md-0 mb-md-5">黑名單會員編輯</h2>
        <div class=" mb-1 pb-1">
          會員編號:
        ...
        <div class="row">
          ...
          <div class="col-12">
            <label for="reason" class="form-label">黑名單備註</label>
            <input type="text" class="form-control" id="reason" name="reason" value="<?= $row['reason'] ?>" />
          </div>
