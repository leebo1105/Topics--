    ...
    <div class="col-lg-6">
      <div class="product-detail">
        <div class="product-image">
          <img src="./image/菜4.jpg" class="img-fluid " alt="熱豆花" />
        </div>
      </div>
    </div>
    <div class="col-lg-6">
        ...
        <p>使用中火將全脂鮮奶油在大型煎鍋中融化，加入洋蔥，炒至軟化，約 5 分鐘。再加入蒜頭，炒 30 秒，直到香氣撲鼻。</p>
              ...
              <div class="cart">
                ...
                <div class="page-wrapper mt-3">
                  <button class="btn  btn-warning btn-lg addToCart" id="4" data-member-id="<?= $memberId ?>" data-product-image="./image/菜1.jpg">加入購物車</button>
