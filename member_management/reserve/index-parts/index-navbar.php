...
<nav class="navbar navbar-expand-lg fixed-top  py-3" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="index-list.php">
            <i class="fas fa-building"></i> 牡丹樓logo
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="card.html"><i class="fas fa-shopping-cart"></i> 購物專區</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#about"><i class="fas fa-utensils"></i> 菜單</a>
                    <div class="dropdown-content">菜單的額外導覽內容</div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#services"><i class="fas fa-info-circle"></i> 關於我們</a>
                    <div class="dropdown-content">
                        <a class="dropdown-item" href="#team">團隊介紹</a>
                        <a class="dropdown-item" href="#history">公司歷史</a>
                        <a class="dropdown-item" href="#mission">使命與願景</a>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#portfolio"><i class="fas fa-calendar-check"></i> 立即預約</a>
