...
if (empty($id)) {
  header('Location: combo_meal-menu.php');
  exit; # 結束 php 程式, die()
}

$sql = "SELECT * FROM combo_meal WHERE id=$id";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="combo_meal-menu.php" class="btn btn-primary">到列表頁</a>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  const sendData = e => {
    ...
    if (priceField.value.length < 4) {
      ...
      priceField.nextElementSibling.innerHTML = '請輸入合菜售價';
    }
